...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/18 17:08:01 by oessayeg          #+#    #+#             */
/*   Updated: 2022/02/22 15:19:55 by oessayeg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "so_long.h"
...
void	put_all_images(t_info *ok, char c, int i, int j)
{
	...
	if (c == '1')
	{
		...
		ok->img = mlx_xpm_file_to_image(ok->mlx, "img/goldcoin.xpm", &a, &b);
	else if (c == 'P')
		ok->img = mlx_xpm_file_to_image(ok->mlx, "img/player.xpm", &a, &b);
